# RailsAdmin config file. Generated on August 28, 2013 00:34
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Health.Me', 'Admin']
  ...
  # config.excluded_models = ['Professional', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Professional', 'Role', 'User']
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your professional.rb model definition
  ...
  #     configure :clinic, :string 
  #     configure :information, :text 
  #     configure :picture, :carrierwave 
  #     configure :experience, :integer 
  #     configure :final_price, :integer 
  #     configure :market_price, :integer 
  #     configure :saving_price, :integer 
